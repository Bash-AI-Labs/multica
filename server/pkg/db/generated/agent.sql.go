...
WHERE id = $1
RETURNING id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, model, custom_env, custom_args, mcp_config, thinking_level, composio_toolkit_allowlist, permission_mode
`
...
SELECT id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, model, custom_env, custom_args, mcp_config, thinking_level, composio_toolkit_allowlist, permission_mode FROM agent
WHERE id = $1
`
