...
func New(cfg Config, logger *slog.Logger) *Daemon {
	// Normalize inherited hardened Git settings before constructing the repo
	// cache. Some cache/worktree operations can run before Run (including
	// diagnostics and tests), so doing this only in Run is too late.
